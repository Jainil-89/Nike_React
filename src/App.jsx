    ...
    <>
      ...
      <div>
        ...
        <nav className='w-full h-20 flex justify-evenly bg-zinc-900 text-white'>
          <img className='w-24 h-auto mr-16 fill-white-900' src="./src/assets/nike(1).png" alt="" />
        ...
        <body className='bg-zinc-900 overflow-hidden w-full h-full'>
          ...
          <div className="box flex">
            ...
            <img className='shu w-90 h-56 mt-40 ml-20 -rotate-45  md:w-90 md:h-56' src="./src/assets/air.png" alt="" />
          ...
          <div className="b flex justify-center rounded-lg mt-28">
            <div className="vid w-4/5 h-auto ">
              <video className='w-full h-4/5 ' src="./src/assets/nike_vid.mp4" autoPlay muted loop></video>
            </div>
          ...
          <div className="c-box snap-x w-auto flex flex-wrap justify-evenly mt-24 h-2/4">
            <Card img="./src/assets/alphafly3.webp" name="Nike Alphafly 3" mrp="22795" />
